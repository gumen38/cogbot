...
function loginKong(name, password, cb){
    ...
    server.callHttp('http://www.kongregate.com/games/callofgods/call-of-gods', { method: 'GET' }, function(rs){

        var authenticity_token = /<meta.*content="(.*)".*name="csrf-token" \/>/.exec(rs.body)[1];
        ...
        server.callHttp('https://www.kongregate.com/session', { body: body, method: 'POST', headers:rs.headers }, function(){
