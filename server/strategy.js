...
function apply(cb) {
    ...
    server.call(rq, function (rs) {
        ...
        function assign() {
            ...
            var atLeastOneAssignChanged = false;
            ...
            if( !atLeastOneAssignChanged ){
                changed = false;
                loaded = true;
                status('Soldiers assign were not changed');
                cb();
            }
        }
    })
